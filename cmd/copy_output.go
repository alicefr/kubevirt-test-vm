...
var KubectlCmd = func(opts []string) error {
...
func (c *copyOutputCommand) run(cmd *cobra.Command, args []string) error {
	...
	if err := KubectlCmd(opts); err != nil {
		return err
	}
...
func isPodRunning(client kubernetes.Interface, p, namespace string) wait.ConditionFunc {
...
func waitPodRunning(client kubernetes.Interface, pod, ns string) error {
