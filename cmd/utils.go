...
type KubernetesClientFunc func(clientConfig clientcmd.ClientConfig) (kubernetes.Interface, error)

var GetKubernetesClient KubernetesClientFunc

func SetKubernetesClientFunc(f KubernetesClientFunc) {
	GetKubernetesClient = f
}

func init() {
	SetKubernetesClientFunc(getKubernetesClient)
}
...
func CreateOutputPVC(client kubernetes.Interface, pvcClaim, namespace string, labels map[string]string) error {
...
func getKubernetesClient(clientConfig clientcmd.ClientConfig) (kubernetes.Interface, error) {
